...
|---|---|---|
| **Windows 10/11** | [`CaptureIt-Setup-2.1.10-win-x64.exe`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.10/CaptureIt-Setup-2.1.10-win-x64.exe) | Run the installer. No administrator rights required. |
| Windows (portable) | [`CaptureIt-Portable-2.1.10-win-x64.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.10/CaptureIt-Portable-2.1.10-win-x64.zip) | Unzip and run the exe |
| **Linux x64** | [`CaptureIt-2.1.10-linux-x64.tar.gz`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.10/CaptureIt-2.1.10-linux-x64.tar.gz) | Extract, then `./install.sh` |
| **macOS (Apple Silicon)** | [`CaptureIt-2.1.10-macos-apple-silicon.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.10/CaptureIt-2.1.10-macos-apple-silicon.zip) | Unzip → **right-click → Open** |
| macOS (Intel) | [`CaptureIt-2.1.10-macos-intel.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.10/CaptureIt-2.1.10-macos-intel.zip) | Unzip → **right-click → Open** |
