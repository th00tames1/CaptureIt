...
| OS | 파일 | 설치 방법 |
|---|---|---|
| **Windows 10/11** | [`CaptureIt-Setup-2.1.8-win-x64.exe`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.8/CaptureIt-Setup-2.1.8-win-x64.exe) | 설치 관리자를 실행합니다. 관리자 권한이 필요하지 않습니다. |
| Windows (무설치) | [`CaptureIt-Portable-2.1.8-win-x64.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.8/CaptureIt-Portable-2.1.8-win-x64.zip) | 압축 풀고 exe 실행 |
| **Linux x64** | [`CaptureIt-2.1.8-linux-x64.tar.gz`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.8/CaptureIt-2.1.8-linux-x64.tar.gz) | 압축 해제 후 `./install.sh` |
| **macOS (Apple Silicon)** | [`CaptureIt-2.1.8-macos-apple-silicon.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.8/CaptureIt-2.1.8-macos-apple-silicon.zip) | 압축 해제 → **우클릭 → 열기** |
| macOS (Intel) | [`CaptureIt-2.1.8-macos-intel.zip`](https://github.com/th00tames1/CaptureIt/releases/download/v2.1.8/CaptureIt-2.1.8-macos-intel.zip) | 압축 해제 → **우클릭 → 열기** |
