...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string en, string ko)> Table = new()
    {
        ...
        ["Status.Ready"] = ("Ready. Choose a capture mode above.", "준비되었습니다. 위에서 캡처 방식을 선택하십시오."),
        ["Status.Saved"] = ("Saved: {0}", "저장 완료: {0}"),
        ["Status.Copied"] = ("Copied to clipboard", "클립보드에 복사되었습니다"),
        ["Status.CopyFailed"] = ("Copy failed: no clipboard tool found. Install xclip or wl-clipboard.", "복사 실패: 클립보드 도구를 찾을 수 없습니다. xclip 또는 wl-clipboard를 설치하십시오."),
        ["Status.Captured"] = ("Captured {0}×{1}", "{0}×{1} 캡처 완료"),
        ["Status.CaptureFailed"] = ("Capture failed: no screenshot tool found. Install one of gnome-screenshot, spectacle, grim+slurp, scrot, or ImageMagick.", "캡처 실패: 스크린샷 도구를 찾을 수 없습니다. gnome-screenshot, spectacle, grim+slurp, scrot, ImageMagick 중 하나를 설치하십시오."),
        ["Status.Cancelled"] = ("Capture cancelled", "캡처가 취소되었습니다"),
        ["Status.Cropped"] = ("Cropped", "잘라내기 완료"),
        ["Overlay.Hint"] = ("Drag to select an area · Esc to cancel", "드래그하여 영역을 선택하십시오 · Esc 취소"),
